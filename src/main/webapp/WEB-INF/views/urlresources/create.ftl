[@override name="title"]访问资源路径管理-创建访问资源路径信息[/@override]
...
<div class="row">
    <div class="col-xs-12">
        [@mc.showAlert /]
        <form action="/url_resources/create" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="urlName" value="${command.urlName!}"
