...
(function() {
    ...
    ModalSearch.prototype = {
        ...
        _paginationRender : function(count, page, pageSize){
            ...
            if (page - 1 <= 0) {
                sb.append("<li class=\"disabled\"><a href=\"#\"><i class=\"icon-double-angle-left\"></i></a></li>");
            } else {
                sb.append("<li><a href=\"" + (page - 1) + "\"><i class=\"icon-double-angle-left\"></i></a></li>");
            }
            ...
            if (page == totalPage) {
                sb.append("<li class=\"disabled\"><a href=\"#\"><i class=\"icon-double-angle-right\"></i></a></li>");
            } else {
                sb.append("<li><a href=\"" + (page + 1) + "\"><i class=\"icon-double-angle-right\"></i></a></li>");
            }
        ...
        renderBody : function(rowList, pageSize){
            ...
            $(rowList).each(function(a, b){
                ...
                if(_this.config.isSingle){
                    var dom_tr = $('<tr><td class="vertical-middle"><div><input class=\"modal_input\" name="optionsRadios" type=\"radio\" vaule="'+ tagVal +'" id="'+ tagVal +'"  ><label for="'+ tagVal +'"></label>' + '</div></td></tr>');
                }else{
                    var dom_tr = $('<tr><td class="vertical-middle"><div><input class=\"modal_input\" type=\"checkbox\" vaule="'+ tagVal +'" id="'+ tagVal +'" ><label for="'+ tagVal +'"></label>' + '</div></td></tr>');
                }

                $(_this.config.rowData).each(function(c ,d){
                    var dom_td = $("<td class='checkTd'>"+ b[d] +"</td>");
