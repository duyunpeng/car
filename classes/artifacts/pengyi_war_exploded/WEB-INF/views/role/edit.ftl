[@override name="title"]角色管理-修改角色[/@override]
    ...
    <div class="col-xs-12">
        ...
        <form action="/role/edit" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="roleName" value="${role.roleName!command.roleName}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="description" value="${role.description!command.description}"
