[@override name="title"]公司用户管理-待审核公司用户列表[/@override]
    ...
    <div class="col-xs-12">
        ...
        <div class="table-responsive">
            <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="pink" href="[@spring.url '/user/company/update_status/?id=${company.id!}&version=${company.version!}'/]">审核通过</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                ...
                [#if pagination??]
                    [@mc.showPagination '/company/auth_list' /]
                [/#if]
