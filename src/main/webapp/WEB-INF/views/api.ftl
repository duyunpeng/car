...
//                }
    ...
    function updatetable(result, current) {
        ...
        $.ajax({
            type: "post",
            url: "/api/apicommand/updatetablename",
